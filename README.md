...
rsi/
  ...
  examples/
    ...
    /Figures
      ...
      figure5_RSI_tail_z0.25.png
      figure5_RSI_tail_z0.50.png
      figure5_RSI_tail_z0.75.png
      figure5_RSI_z0.25.png
      figure5_RSI_z0.50.png
      figure5_RSI_z0.75.png
      figure5_SI_coarse_z0.25.png
      figure5_SI_coarse_z0.50.png
      figure5_SI_coarse_z0.75.png
      figure5_SI_fine_z0.25.png
      figure5_SI_fine_z0.50.png
      figure5_SI_fine_z0.75.png
    plot_figure2.py
    plot_figure5.py
```
...
example1 边界条件在 y=0 且 x∈[0.4,0.6] 的区域给定入流：
ψ_in = 10 exp(-Ω_x^2 - Ω_y^2)，其他边界均视为真空入流
